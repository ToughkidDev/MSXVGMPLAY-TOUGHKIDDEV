...
; Reads and validates the raw 256-byte header.  GzipStreamReader needs this
; split form so it can replay command bytes that begin inside that first
; 256-byte window before Header_Finalize clears non-header bytes.
; ix = this
; iy = reader
Header_Read:
	ld e,ixl
...
; Removes bytes beyond the declared header and applies compatibility fixes.
; ix = this
Header_Finalize:
